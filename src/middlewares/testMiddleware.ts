...
const authenticationEventRepository = new AuthenticationEventRepository(strategy)
...
const testMiddleware = async (
    ...
    const model = await authenticationEventRepository.getAuthenticationEventByAuthorizationCode("authorization_code_value");
    console.log('test middleware');
    res.send(model);
};
